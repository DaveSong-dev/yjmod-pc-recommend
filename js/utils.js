...
/**
 * 가격대 텍스트를 범위 객체로 변환
 * - 레거시 4구간 유지 (filter.js 하위 호환)
 * - 세분화 7구간 추가 (새 필터 패널·퀵필터 행)
 */
const PRICE_RANGES = {
  // ── 세분화 구간 (새 UI) ──────────────────────────
  '~100만 원':       { min: 0,         max: 1000000  },
  '100~150만 원':    { min: 1000000,   max: 1500000  },
  '150~200만 원':    { min: 1500000,   max: 2000000  },
  '200~300만 원':    { min: 2000000,   max: 3000000  },
  '300~500만 원':    { min: 3000000,   max: 5000000  },
  '500~1000만 원':   { min: 5000000,   max: 10000000 },
  '1000만 원 이상':  { min: 10000000,  max: Infinity },
  // ── 레거시 구간 (하위 호환) ──────────────────────
